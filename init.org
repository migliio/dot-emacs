...
#+begin_src emacs-lisp
  ...
  (global-set-key (kbd "C-c f b l") #'list-bookmarks)
...
#+begin_src emacs-lisp
  ...
  (global-set-key (kbd "C-x / f") #'mg/open-pages-file)
  ...
  (global-set-key (kbd "C-c g u d") #'mg/check-and-toggle-deepwork-mode)
  (global-set-key (kbd "C-c g u c") #'mg/check-deepwork-mode)
#+end_src
...
#+begin_src emacs-lisp
  ...
  (use-package org-sidebar
    :ensure t
    :bind
    (("C-c g b b" . org-sidebar-backlinks)
     ("C-c g b s" . org-sidebar-toggle)
     ("C-c g b t" . org-sidebar-tree))
    :custom
...
#+begin_src emacs-lisp
  ...
  (global-set-key (kbd "C-c f d") 'mg/find-docker-and-enter-in-assets)
#+end_src
