  ...
  (use-package org
   ...
   (buffer-name (plist-get org-capture-plist :original-buffer)))\n:PROPERTIES:\n:ANKI_DECK: English\n:ANKI_NOTE_TYPE: Basic\n:END:\n** Front\n%?\n** Back\n")
    ...
    (setq org-refile-targets '(("~/Vault/pkm/20231210T220334--work-and-study-projects__project_work.org" :regexp . "\\(?:\\(?:Log\\|Task\\)s\\)")
  			       ...
  			       ("~/Vault/pkm/20240102T104309--books__personal_reading.org" :regexp . "\\(?:\\(?:2023\\|2024\\)s\\)")
  ...
  (use-package denote
    ...
    (denote-dired-directories
     (list denote-directory
  	 ...
  	 (thread-last denote-directory (expand-file-name "contacts")
  		      )
  	 (thread-last denote-directory (expand-file-name "places")
  		      )))
    (add-hook 'dired-mode-hook #'denote-dired-mode-in-directories)
    (denote-templates
     '((plain . "")
    ...
    (defun mg-denote-add-identifier-to-killring ()
...
#+begin_src emacs-lisp
  ...
  (global-set-key (kbd "C-c p u t") #'mg-denote-add-identifier-to-killring)
