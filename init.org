    ...
    (setq org-capture-templates
  	  '(("i" "Inbox")
  	    ...
  	    ("ac" "Call entry" entry (file+headline "~/Vault/pkm/20231210T224321--agenda__personal.org" "Future")
  	     "* Call with %? :call:\n:LOGBOOK:\n- Entry inserted on %U \\\\\n:END:\n:PROPERTIES:\n:NOTIFY_BEFORE:\n:CATEGORY:\n:END:\n%^T\n")
  	    ("j" "Journal")
  	    ("jt" "Journal time blocking entry" plain (file+datetree "~/Vault/pkm/20240209T084736--journal__archive_personal.org") "**** Time blocking :timeblocking:\n***** Deep work morning session\n<%(concat (mg/get-today-timestamp) \" 07:00-11:00\")>\n- [ ] Task :: <link>\n- Outcome :: \n***** Deep work afternoon session\n<%(concat (mg/get-today-timestamp) \" 13:30-15:30\")>\n- [ ] Task :: <link>\n- Outcome :: \n***** Shallow work afternoon session\n<%(concat (mg/get-today-timestamp) \" 15:30-17:00\")>\n- [ ] Task :: <link>\n- Outcome :: \n%?")
  	    ("jr" "Journal daily reflections entry" plain (file+datetree "~/Vault/pkm/20240209T084736--journal__archive_personal.org") "**** Daily reflections :reflections:\n- Key takeaways :: \n- Daily review :: \n***** Resources found today\n- \n***** Ideas vault\n- \n")
...
#+begin_src emacs-lisp
  (use-package multiple-cursors
    ...
    :bind (
  	 ...
  	 ("C-c u c m e" . 'mc/mark-more-like-this-extended)
  	 ("C-c u c m s" . 'mc/mark-all-dwim)
  	 ("C-c u c m a" . mc/mark-all-like-this)
  	 ("C-c u c m r" . mc/mark-all-in-region)
  	 ("C-c u c m d" . mc/mark-all-like-this-dwim)
  	 ("C-c u c m w" . mc/mark-all-words-like-this)))
#+end_src
