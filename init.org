...
(use-package exwm
  ...
  (setq exwm-systemtray--icon-min-size 13)

  ;; assign workspaces to monitors
  (setq exwm-randr-workspace-monitor-plist '(4 "HDMI1" 5 "HDMI1"))
  ...
  (add-hook 'exwm-init-hook
		...
		(start-process "xss-lock" nil "xss-lock" "-n /usr/lib/xsecurelock/dimmer -l -- xsecurelock"))))
  (exwm-enable))
...
(defun mg/display-machine-info()
  ...
  (message "System-level info: %s" (concat
		 ...
		 (format "Disk: %s - " (shell-command-to-string "~/.config/scripts/disk.sh"))
