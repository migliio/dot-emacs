  ...
  (if (display-graphic-p)
      (progn
  	  ...
  	  (progn
  	    ...
  	    (use-package solarized-theme :straight t :config
...
#+begin_src emacs-lisp
  ...
  (use-package consult-denote
    ...
    :bind (("C-c n u c g" . consult-denote-grep)
  	 ("C-c n u c f" . consult-denote-find)))
#+end_src
...
Using ~tree-sitter~ for a better syntax highlighting.
