...
This is the list of keybindings I use, with a modal editing fashion.
...
#+begin_src emacs-lisp
  (use-package god-mode
    ...
    (defun mg/god-mode-update-indicators ()
      (progn
    ...
    (add-hook 'post-command-hook #'mg/god-mode-update-indicators)
