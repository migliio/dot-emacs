...
#+begin_src emacs-lisp
  (if (display-graphic-p)
  	...
  	(set-frame-font "Iosevka Comfy 16" nil t))
        (use-package spacious-padding :straight t :config (spacious-padding-mode 1))
        (use-package ef-themes :straight t :config (load-theme 'ef-dream t))
        (set-fringe-mode 0))
...
#+begin_src emacs-lisp
  (use-package vundo
    ...
    (set-face-attribute 'vundo-default nil :height 1.1))
#+end_src
