...
#+begin_src emacs-lisp
  ...
  (if (display-graphic-p)
      (progn
  	  ...
  	  (progn
  	    (use-package modus-themes :straight t :config (load-theme 'modus-operandi t))
  ...
  (use-package org
    ...
    (setq org-capture-templates
  	  '(("i" "Inbox")
  	    ...
  	    ("fc" "Mathematics flashcard" entry (file+headline "~/Vault/pkm/20240220T165813--flashcards__learning_personal.org" "Mathematics") "* %^{Heading title}\n:PROPERTIES:\n:ANKI_DECK: Mathematics\n:ANKI_NOTE_TYPE: %^{Anki note type}\n:END:\n** Front\n%?\n** Back\n")  	    
