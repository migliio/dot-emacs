...
#+begin_src emacs-lisp
  (use-package avy
    ...
    (eval-after-load 'org
      (progn
	(define-key org-mode-maporg-mode-map ,") nil)
	(define-key org-mode-maporg-mode-map ;") nil)))org-mode-map ," . avy-goto-char)
     ("C-c ;" . avy-goto-line)))
#+end_src
...
#+begin_src emacs-lisp
  ...
  (use-package org
    ...
    (defun extract-heading-name (heading)
	...
	(let* ((id (org-id-get-create))
	       (heading-title (extract-heading-name (org-get-heading t t t)))
    ...
    (setq org-refile-targets '(("~/Vault/pkm/20231210T220334--work-and-study-projects__personal_project.org" :regexp . "\\(?:\\(?:Log\\|Task\\)s\\)")
			   ...
			   b    ("~/Vault/pkm/20231210T224321--agenda__personal.org" :regexp . "\\(?:Past\\)")))
...
#+begin_src emacs-lisp
  (use-package citar
    ...
    (("C-c n c o" . citar-open)
     (:map org-mode-map :package org ("C-c b" . #'orgorg-mode-map
...
#+begin_src emacs-lisp
  ...
  (global-set-key (kbd "C-c u r a s") #'align-sexp)
