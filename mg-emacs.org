...
The structure of this file goes as follows. Section 1) describes the startup activities performed by my Emacs configuration. Section 2) analyzes the packages I use and how those packages are set up. Finally, Section 3) goes into details for the custom code I developed to extend the Emacs editor and its packages.
