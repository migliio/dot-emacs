...
** The ~mg-emacs-projects.el~ module

This module introduces some packages (for now, simply ~projectile~) I use to manage projects within Emacs. When working with large projects, like my personal knowledge management system, the Linux kernel and the like, having a way to quickly search and manage file within those projects is pretty handy. For now, this module is extremely simple, but may grow in complexity in the future.

#+begin_src emacs-lisp :tangle "mg-emacs-modules/mg-emacs-projects.el"
